"""This is a list of possible path extensions in which the program will sort based on.
For example, it will sort by text paths, video paths, programmming paths, etc..."""
